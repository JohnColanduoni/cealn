...
// The libc crate in wasi mode doesn't define wchar_t
// Since we compile Python with emscripten in this situation, it is 32-bit
#[cfg(any(target_env = "wasi", target_os = "wasi"))]
type wchar_t = u32;
#[cfg(not(any(target_env = "wasi", target_os = "wasi")))]
type wchar_t = ::libc::wchar_t;
